...
public:
    ...
    static Vector3 Multiply(const Matrix& A, const Vector3& B)
    {
        float X = A.m00 * B.X + A.m10 * B.Y + A.m20 * B.Z + A.m30 * 1;
        float Y = A.m01 * B.X + A.m11 * B.Y + A.m21 * B.Z + A.m31 * 1;
        float Z = A.m02 * B.X + A.m12 * B.Y + A.m22 * B.Z + A.m32 * 1;
